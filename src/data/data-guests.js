...
function generateGuestData(count) {
    const data = [];
    const names = [
        "John",
        "Jane",
    ...
    for (let i = 0; i < count; i++) {
        ...
        const nationalID = Math.floor(Math.random() * 1000000000).toString(); // Generate random 10 digit ID
        const countryFlag = countryFlags[nationality];
...
export const guests = generateGuestData(50);
